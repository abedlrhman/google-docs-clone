...
import { GET_NEW_USER, GET_OWN_USER, GET_USER } from '../ducks/userData'
...
import { handleGetOwnUser } from './handlers/getOwnUser'
...
export function* watcherSaga () {
	...
	yield takeLatest(GET_OWN_USER, handleGetOwnUser)
}